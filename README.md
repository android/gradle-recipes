...
* Artifact API - [addMultipleArtifact](addMultipleArtifact), [transformManifest](transformManifest), [workerEnabledTransformation](workerEnabledTransformation), [appendToScopedArtifacts](appendToScopedArtifacts), [appendToMultipleArtifact](appendToMultipleArtifact), [transformAllClasses](transformAllClasses), [getSingleArtifact](getSingleArtifact), [getScopedArtifacts](getScopedArtifacts), [getMultipleArtifact](getMultipleArtifact), [transformDirectory](transformDirectory), [createSingleArtifact](createSingleArtifact)
...
* AndroidComponentsExtension.onVariants() - [addGeneratedSourceFolder](addGeneratedSourceFolder), [onVariants](onVariants), [addMultipleArtifact](addMultipleArtifact), [transformManifest](transformManifest), [workerEnabledTransformation](workerEnabledTransformation), [variantOutput](variantOutput), [variantDependencySubstitutionTest](variantDependencySubstitutionTest), [appendToScopedArtifacts](appendToScopedArtifacts), [addCustomSourceType](addCustomSourceType), [appendToMultipleArtifact](appendToMultipleArtifact), [allProjectsApkAction](allProjectsApkAction), [transformAllClasses](transformAllClasses), [getSingleArtifact](getSingleArtifact), [perVariantManifestPlaceholder](perVariantManifestPlaceholder), [getScopedArtifacts](getScopedArtifacts), [asmTransformClasses](asmTransformClasses), [legacyTaskBridging](legacyTaskBridging), [extendingAgp](extendingAgp), [getMultipleArtifact](getMultipleArtifact), [addCustomBuildConfigFields](addCustomBuildConfigFields), [transformDirectory](transformDirectory), [createSingleArtifact](createSingleArtifact)
...
* Artifacts.use() - [transformManifest](transformManifest), [workerEnabledTransformation](workerEnabledTransformation), [appendToMultipleArtifact](appendToMultipleArtifact), [transformDirectory](transformDirectory), [createSingleArtifact](createSingleArtifact)
