# Recipes for AGP version `9.4`
This branch contains recipes compatible with AGP 9.4. If you want to find recipes
...
* Android Manifest - [Transform Manifest (Meta-data)](transformManifest), [perVariantManifestPlaceholder](perVariantManifestPlaceholder), [createSingleArtifact](createSingleArtifact)
* Artifact API - [addMultipleArtifact](addMultipleArtifact), [Transform Manifest (Meta-data)](transformManifest), [workerEnabledTransformation](workerEnabledTransformation), [appendToScopedArtifacts](appendToScopedArtifacts), [appendToMultipleArtifact](appendToMultipleArtifact), [listenToMultipleArtifact](listenToMultipleArtifact), [transformAllClasses](transformAllClasses), [getSingleArtifact](getSingleArtifact), [listenToArtifacts](listenToArtifacts), [getScopedArtifacts](getScopedArtifacts), [getMultipleArtifact](getMultipleArtifact), [transformMultiple](transformMultiple), [transformDirectory](transformDirectory), [createSingleArtifact](createSingleArtifact)
...
* Signing Configuration - [signingConfigProvider](signingConfigProvider)
...
* Artifacts.get() - [addGeneratedSourceFolder](addGeneratedSourceFolder), [addMultipleArtifact](addMultipleArtifact), [Transform Manifest (Meta-data)](transformManifest), [variantOutput](variantOutput), [appendToMultipleArtifact](appendToMultipleArtifact), [allProjectsApkAction](allProjectsApkAction), [getSingleArtifact](getSingleArtifact), [perVariantManifestPlaceholder](perVariantManifestPlaceholder), [legacyTaskBridging](legacyTaskBridging), [transformMultiple](transformMultiple), [transformDirectory](transformDirectory)
* Artifacts.getAll() - [getMultipleArtifact](getMultipleArtifact)
* Artifacts.use() - [Transform Manifest (Meta-data)](transformManifest), [workerEnabledTransformation](workerEnabledTransformation), [appendToMultipleArtifact](appendToMultipleArtifact), [listenToMultipleArtifact](listenToMultipleArtifact), [listenToArtifacts](listenToArtifacts), [transformMultiple](transformMultiple), [transformDirectory](transformDirectory), [createSingleArtifact](createSingleArtifact)
...
* SigningConfig.from() - [signingConfigProvider](signingConfigProvider)
...
* SingleArtifact.MERGED_MANIFEST - [Transform Manifest (Meta-data)](transformManifest), [variantOutput](variantOutput), [perVariantManifestPlaceholder](perVariantManifestPlaceholder), [createSingleArtifact](createSingleArtifact)
