...
abstract class UpdateBundleFileTask : DefaultTask() {
    @get:InputFiles abstract val initialBundleFile: RegularFileProperty

    @get:OutputFile abstract val updatedBundleFile: RegularFileProperty
...
abstract class ConsumeBundleFileTask : DefaultTask() {
    @get:InputFiles abstract val finalBundle: RegularFileProperty
...
android {
    ...
    onVariantProperties {
        val updateBundle =
            project.tasks.register<UpdateBundleFileTask>("${name}UpdateBundleFile") {
        ...
        artifacts
            .use(updateBundle)
            .wiredWithFiles(
                UpdateBundleFileTask::initialBundleFile, UpdateBundleFileTask::updatedBundleFile)
